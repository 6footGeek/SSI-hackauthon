...
import _6FootgeekIdentity06FootgeekIdentity0Identity0 from './6footgeek/identity0/_6footgeek.identity0.identity0';
import _6FootgeekIdentity0ExampleBlogBlog from './6footgeek/identity0/example.blog.blog';
import CosmosCosmosSdkIbcCoreClientV1 from './cosmos/cosmos-sdk/ibc.core.client.v1';
import _6FootgeekIdentity0SixfootgeekIdentity from './6footgeek/identity0/sixfootgeek.identity';
export default {
    ...
    _6FootgeekIdentity06FootgeekIdentity0Identity0: load(_6FootgeekIdentity06FootgeekIdentity0Identity0, '_6footgeek.identity0.identity0'),
    _6FootgeekIdentity0ExampleBlogBlog: load(_6FootgeekIdentity0ExampleBlogBlog, 'example.blog.blog'),
    CosmosCosmosSdkIbcCoreClientV1: load(CosmosCosmosSdkIbcCoreClientV1, 'ibc.core.client.v1'),
    _6FootgeekIdentity0SixfootgeekIdentity: load(_6FootgeekIdentity0SixfootgeekIdentity, 'sixfootgeek.identity'),
};
