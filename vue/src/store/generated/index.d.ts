declare const _default: {
    ...
    _6FootgeekIdentity06FootgeekIdentity0Identity0: (store: any) => void;
    _6FootgeekIdentity0ExampleBlogBlog: (store: any) => void;
    CosmosCosmosSdkIbcCoreClientV1: (store: any) => void;
    _6FootgeekIdentity0SixfootgeekIdentity: (store: any) => void;
};
